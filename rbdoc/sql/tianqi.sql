...
CREATE TABLE `tb_role` (
  ...
  `dtUpdateTime` datetime DEFAULT NULL COMMENT '更新时间',
  `dtCreateTime` datetime DEFAULT NULL COMMENT '创建时间',
  `nMaxHP` int(10) DEFAULT '0',
  `nMaxMP` int(10) DEFAULT '0',
  PRIMARY KEY (`lId`)
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_role` VALUES ('1', '1', '慕临风', '一剑霜寒十四州', '0', '50', '45897228', '5849', '1209', '100', '257', '324', '547', '588', '432', '878', '112', '210', '100', '60', '200', '70', '30', '100.00', '100.00', '100.00', '0.00', '0.00', '0.00', 'tzy', '11', '12', '0', null, null, '2019-01-05 12:16:58', null, null);
COMMIT;
